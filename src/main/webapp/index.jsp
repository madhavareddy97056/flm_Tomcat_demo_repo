...
<body>
	...
	<h1 style="color: pink; font-size: 40px;" align="center">Madhava Reddy Bonam</h1>
	<h1 style="color: pink; font-size: 40px;" align="center">Welcome and Thanks for support</h1>
